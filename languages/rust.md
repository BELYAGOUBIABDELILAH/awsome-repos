...
*All trending Rust repositories tracked in this archive*
...
| Repository | Stars | First Seen | Description |
|------------|-------|------------|-------------|
| [1jehuang/jcode](../repos/1jehuang/jcode.md) | ⭐ 17,331 | 2026-08-01 | The most RAM efficient harness |
| Repository | Stars | First Seen | Description |
|------------|-------|------------|-------------|
...
| [aaif-goose/goose](../repos/aaif-goose/goose.md) | ⭐ 53,253 | 2026-08-19 | 4 |
...
- [openai/codex](../repos/openai/codex.md) - Lightweight coding agent that runs in your terminal
...
- [wealthfolio/wealthfolio](../repos/wealthfolio/wealthfolio.md) - A beautiful, private, local-first personal finance tracker. Investments, net worth, spending, and...
- [rust-lang/rust-clippy](../repos/rust-lang/rust-clippy.md) - A bunch of lints to catch common mistakes and improve your Rust code. Book: https:&#x2F;&#x2F;doc.rust-lang...
- [emilk/egui](../repos/emilk/egui.md) - egui: an easy-to-use immediate mode GUI in Rust that runs on both web and native
- [n0-computer/iroh](../repos/n0-computer/iroh.md) - IP addresses break, dial keys instead. A library that adds QUIC + NAT Traversal to your apps.
- [nushell/nushell](../repos/nushell/nushell.md) - A new type of shell
- [vercel/turborepo](../repos/vercel/turborepo.md) - Build system optimized for JavaScript and TypeScript, written in Rust
...
- [juspay/hyperswitch](../repos/juspay/hyperswitch.md) - Open source, composable payments platform | PCI compliant | SaaS and Self-host options | Enables ...
